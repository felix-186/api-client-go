...
const (
	...
	WarnService_GetWarnStats_FullMethodName = "/warning.WarnService/GetWarnStats"
)
...
type WarnServiceClient interface {
	...
	GetWarnStats(ctx context.Context, in *WarnStatsRequest, opts ...grpc.CallOption) (*api.Response, error)
}
...
func (c *warnServiceClient) Query(ctx context.Context, in *QueryWarningRequest, opts ...grpc.CallOption) (*api.Response, error) {
	...
	err := c.cc.Invoke(ctx, WarnService_Query_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *warnServiceClient) Get(ctx context.Context, in *GetOrDeleteWarningRequest, opts ...grpc.CallOption) (*api.Response, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(api.Response)
	err := c.cc.Invoke(ctx, WarnService_Get_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *warnServiceClient) Create(ctx context.Context, in *api.CreateRequest, opts ...grpc.CallOption) (*api.Response, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(api.Response)
	err := c.cc.Invoke(ctx, WarnService_Create_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *warnServiceClient) BatchCreate(ctx context.Context, in *api.CreateRequest, opts ...grpc.CallOption) (*api.Response, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(api.Response)
	err := c.cc.Invoke(ctx, WarnService_BatchCreate_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *warnServiceClient) GetWarnStats(ctx context.Context, in *WarnStatsRequest, opts ...grpc.CallOption) (*api.Response, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(api.Response)
	err := c.cc.Invoke(ctx, WarnService_GetWarnStats_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type WarnServiceServer interface {
	...
	GetWarnStats(context.Context, *WarnStatsRequest) (*api.Response, error)
	mustEmbedUnimplementedWarnServiceServer()
}

// UnimplementedWarnServiceServer must be embedded to have
...
func (UnimplementedWarnServiceServer) GetWarnStats(context.Context, *WarnStatsRequest) (*api.Response, error) {
	return nil, status.Error(codes.Unimplemented, "method GetWarnStats not implemented")
}
func (UnimplementedWarnServiceServer) mustEmbedUnimplementedWarnServiceServer() {}
func (UnimplementedWarnServiceServer) testEmbeddedByValue()                     {}
...
func RegisterWarnServiceServer(s grpc.ServiceRegistrar, srv WarnServiceServer) {
	// If the following call panics, it indicates UnimplementedWarnServiceServer was
...
func _WarnService_GetWarnStats_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(WarnStatsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(WarnServiceServer).GetWarnStats(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: WarnService_GetWarnStats_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WarnServiceServer).GetWarnStats(ctx, req.(*WarnStatsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var WarnService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetWarnStats",
			Handler:    _WarnService_GetWarnStats_Handler,
		},
	},
...
func (c *ruleServiceClient) Query(ctx context.Context, in *api.QueryRequest, opts ...grpc.CallOption) (*api.Response, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(api.Response)
	err := c.cc.Invoke(ctx, RuleService_Query_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *ruleServiceClient) BatchCreate(ctx context.Context, in *api.CreateRequest, opts ...grpc.CallOption) (*api.Response, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(api.Response)
	err := c.cc.Invoke(ctx, RuleService_BatchCreate_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *ruleServiceClient) Replace(ctx context.Context, in *api.UpdateRequest, opts ...grpc.CallOption) (*api.Response, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(api.Response)
	err := c.cc.Invoke(ctx, RuleService_Replace_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
